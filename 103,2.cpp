...
void StudentInfoFile(string str1, string str2, string str3, string str4, string str5, string str6, string str7)
{
  ...
  */
  ...
  L1 = "Name:" + Sp + str1 + Tb + str1 + Sp + "'s Age:" + Sp + str2 + Tb + str1 + Sp + "'s Yearlevel" + Sp + str3;
  L2 = "Home address of" + Sp + str1 + Sp + ":" + Sp + str4;
  L3 = "Name of" + Sp + str1 + Sp + "'s Parents:" + Sp + str5 + Tb + str1 + Sp + "'s Parents Phonenumbers" + Sp + str6;
  string command = SC + L1 + NL + L2 + NL + L3 + EC + Path;
...
void AddStudent()
{
  ...
  string Warning = "Class already exists"; // Warns if the inputed class already exists;
  // Other info.↓
  cout << "The student's teacher's name : "<< endl; // The students teacher's name
  getline(cin, TeacherName);
  TeacherName = Formatter(TeacherName);
